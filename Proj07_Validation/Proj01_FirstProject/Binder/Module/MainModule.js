...
var MainModuleModule = (function () {
    ...
    MainModuleModule = __decorate([
        core_1.NgModule({
            imports: [router_1.RouterModule.forRoot(AppRouting_1.ApplicationRoutes),
                platform_browser_1.BrowserModule, forms_1.FormsModule, forms_2.ReactiveFormsModule, common_1.CommonModule],
